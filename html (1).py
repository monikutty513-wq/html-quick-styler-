...
Original file is located at
    https://colab.research.google.com/drive/1u9BGHlRp7MX-itSg2ZYyU4wc8W5cU3i3
"""
...
try:
    ...
    model_loaded = False
    print("Granite model could not load. Running in template mode.")
...
class ColorPaletteGenerator:
    ...
    @staticmethod
    def get(style):
        return ColorPaletteGenerator.palettes.get(style,"modern")
...
class HTMLBuilder:
    ...
    @staticmethod
    def detect_sections(desc:str)->List[str]:
        ...
        if "feature" in desc or "service" in desc:
...
def generate_html(title,desc,style):
    ...
    palette = ColorPaletteGenerator.get(style)

    sections = HTMLBuilder.detect_sections(desc)
